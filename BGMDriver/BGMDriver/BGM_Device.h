...
private:
    ...
    #define kDeviceName                 "Claap Background Music"
    #define kDeviceName_UISounds        "Claap Background Music (UI Sounds)"
    #define kDeviceManufacturerName     "Claap Background Music contributors"
